...
<title>BanYQ's图书管理系统-关于网站</title>
...
<body style="background-color: rgb(248,248,248)">
	...
	<header role="banner">
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="about-tab">关于网站</a></li>
					</ul>
				</div>
			</div>
		</nav>
	    ...
	    <div>
        <div class="img-main">
            <img class="img-responsive" src="img/about.png" alt="1">
        </div>
	...
	<div class="container">
    	<div class="row">
    		<div class="col-sm-12">
    			<div class="history-board margin-top30">
    				<div class="item-header about-color">
    				</div>
    				<div class="history-height">
    					<div style="margin:0 auto; width:50%;height:90%;">
	    					<h1>BanYQ's 图书管理系统</h1>
	    					<h3 class="pull-right">---- for SE lab2</h3>
	    					<img alt="about" src="logo/logo.png" class="img-responsive">
	    					<h4>logo来自网络在线生成..</h4>
    					</div>
    				</div>
    			</div>
