        ...
        <div class="row">
           <div class="col-md-12">
               <div class="query-border" style="padding:100px 100px 100px 100px;">
	               <div class="item-header failure-color">
	                </div>
               		<div>
               			<table>
               				<tr>
               					<td rowspan="2">
               						<img src="img/fail.png" height="300px" width="300Px" style="float:left" class="img-responsive">
               					</td>
               					<td>
               						<span style="font-size:30px;float:left;">添加失败，图书已在库中，请核对ISBN！！</span>
               					</td>
               				</tr>
               				<tr>
               					<td>
               						<a href="manage-tab" class="btn btn-lg btn-warning">请重试</a>
               					</td>
               				</tr>
               			</table>
               		</div>
