...
<body style="background-color: rgb(248,248,248)">
	...
	<header role="banner">
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="history-tab">更新历史</a></li>
	    ...
	    <div>
        <div class="img-main">
            <img class="img-responsive" src="img/history.png" alt="1">
        </div>
    	...
    	<div class="row">
    		<div class="col-md-12">
    			<div class="history-board margin-top30">
    				<div class="item-header history-color">
    				</div>
    				<div class="history-height">
    					<table class="table">
    						<s:iterator value="logs" var="history">
    							<tr>
    								<td>
    									<span>${history }</span>
    								</td>
