...
<title>BanYQ's图书管理系统-图书管理</title>
...
<body style="background-color: rgb(248,248,248)">
	...
	<header role="banner">
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="manage-tab">添加新项</a></li>
	    ...
	    <div>
        <div class="img-main">
            <img class="img-responsive" src="img/manage.png" alt="1">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 query-result">
            	<div class="query-border">
            		<div class="item-header manage-color">
            		</div>
	            		<div class="query-optons">
	            			<ul class="nav nav-tabs nav-justified">
		                        <li class="active"><a href="#book" data-toggle="tab"><span>新图书</span></a></li>
		                        <li><a href="#author" data-toggle="tab"><span>新作者</span></a></li>
		                    </ul>
		                        ...
		                        <div class="tab-pane fade in active query-option-padding" id="book">
		                            <form action="add-new-book">
		                                <table align="center" width="95%" cellpadding="10" cellspacing="10" class="table">
		                                    ...
		                                    <tr>
		                                    	<td>出版日期：</td>
		                                    	<td colspan="2"><input type="date" class="form-control input-md" name="publishDate" id="PublishDate"></td>
		                                        <td><span>&nbsp;&nbsp;&nbsp;</span></td>
		                                        <td>价格：</td>
		                                        <td colspan="2"><input type="text" class="form-control input-md" name="price" id="Price"></td>
		                                    </tr>
		                                </table>
		                                <span>以上选项均为必填项，若所添加数据为新作者，请先添加该作者然后再添加新书!!!</span>
		                                <input type="button" class="btn btn-default btn-lg pull-right"  onclick="checkBookInput(this)" value="确认">
		                        ...
		                        <div class="tab-pane fade query-option-padding" id="author">
		                            <form action="add-new-author">
		                                <table align="center" width="95%" cellpadding="10" cellspacing="10" class="table">
		                                    ...
		                                    <tr>
		                                        <td colspan="7">
		                                            <input type="text" class="form-control input-md" name="age" id="Age">
		                                        </td>
		                                    </tr>
		                                    <tr>
		                                        <td>国籍 ：</td>
		                                ...
		                                <br><br><br>
		                                <span>以上选项均为必填项!!</span><br>
		                                <input type="button" class="btn btn-default btn-lg pull-right" onClick="checkAuthorInput(this)" value="确认">
		                                <input type="reset" class="btn btn-default btn-lg pull-right" value="重置">
		                            </form>
		                        </div>
	            		</div>
